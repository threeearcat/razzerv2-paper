...
instructions, but race conditions mostly are \textit{combined results of multiple pairs} of conflicting accesses.
%
...
depending on a partial order of a few memory accesses\yj{how to understand this sentence}.
%
