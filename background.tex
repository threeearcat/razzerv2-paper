...
\begin{figure}[t]
  ...
  \caption{Simplified code snippet of CVE-2019-6974. A \texttt{BUG()}
    ...
    value by 1 and tests the result is 0.\yj{Where is B4? where is the \texttt{atomic_dec_and_test()}?}}
  \label{fig:cve-2019-6974}
\end{figure}

\autoref{fig:cve-2019-6974} explains a case.  In this
...
causes a use-after-free bug because the object would be freed,
if a reference count hits \texttt{0}, 
