...
picks a single pair of instructions that access the same memory object
\texttt{X} and \texttt{Y}, and enforce their execution order such that
\texttt{X} is executed before \texttt{Y}.
%
