...
%
2) a \textit{thread interleaving search strategy} determines which
thread interleaving to run on each iteration.
...
coverage metrics.
%
Proposed interleaving coverage metrics are used to track the execution
