...
Since the kernel is a de facto security basis of most systems, it is
paramount to eliminate vulnerabilities in the kernel to improve the
...
discover vulnerabilities in the kernel as the first step to eliminate
them.

These fuzzing approaches mostly focus on how to explore source codes
residing deep inside the kernel.
...
While conventional fuzzing techniques show the effectiveness,
