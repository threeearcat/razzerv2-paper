...
execute a massive number of single-thread inputs (\ie, sequences of
system calls) while tracking the execution path that each input
explores by using a code coverage metric (\eg, branch coverage).
%
