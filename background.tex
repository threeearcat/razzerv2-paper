...
%
In this section, we introduce prior fuzzing approaches 1) to discover
bugs in the kernel~(\autoref{ss:kernelfuzzing}), and 2) to discover
concurrency bugs~(\autoref{ss:concurrencyfuzzing}).
