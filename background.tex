...
scheduling as a fuzzer wants, and depending on a concurrency fuzzer,
...
On the other hand, a thread interleaving search strategy is adopted
for a fuzzer to determine which thread interleaving to run for each
iteration.
%
\dr{TODO: explain correctly: }For instance, Krace~\cite{krace} randomly
