...
using a code coverage metric such as branch coverage.
%
...
%
These approaches generally adopt two strategies, namely a coverage
metric in the thread interleaving dimension (shortly, interleaving
coverage metric) to capture interesting behaviors of thread
interleavings, and a thread scheduling control mechanism to tame the
non-deterministic behavior of thread interleaving.
...
\PP{Interleaving coverage metric.} \dr{TODO: rewrite}
%
...
\PP{Thread scheduling control mechanism.} \dr{TODO: rewrite}
%
%
Instead of relying on the uncontrollable kernel scheduler, concurrency
fuzzing generally consists of a thread scheduling control mechanism to
increase the probability of bugs being exposed.
%
Depending on how itschedules instructions, it is largely categorized
