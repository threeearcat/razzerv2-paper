...
\autoref{fig:racecondition} explains the above survey. An example
execution scenario that a use-after-free bug manifests is that
instructions are executed in the order of \dr{TODO}.
%
...
manifest.
%
In detail, the condition \dr{TODO} is satisfied, the use-after-free bug always manifests.

In the perspective of fuzzer, all interleavings that satisfy the above
condition are equivalent in terms of the manifestation of the race
condition.
%
