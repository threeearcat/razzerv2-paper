...
result.
%
As the figure shows, the difficulty of discovering varies from bug to
bug. For example, \texttt{CVE-2018-12232} appears the easiest
concurrency bug to discover since it can be easily discovered even
without any thread scheduling control.
%
On the other hand, three concurrency bugs, \texttt{CVE-2019-6974},
\texttt{CVE-2019-11486}, and \texttt{69e16d01d1de} 
