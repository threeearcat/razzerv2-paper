...
fuzzer.
%
Then, we observe how each fuzzer explore thread interleavings of a
given pair of system calls. During the evaluation, we limit the number
of executions to 10000 if a concurrency bug if a fuzzer fails to
discover a concurrency bug.
