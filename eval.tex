...
\begin{table*}
  ...
  \caption{Result of the comparison study against various
    ...
    number of executions and the elapsed time (ms) required to
...
single-thread fuzzing~(\autoref{sss:singlethreadfuzzing}), and manually
...
\sys can discover all of concurrency bugs extremely fast.
%
\sys can discover a given concurrency bug in just 9.3 runs on average,
...
%
We also justify the choice of our interleaving coverage by showing
what happens if a fuzzer adopts less-informative interleaving
coverage.
