...
discover all of concurrency bugs very effectively.
%
...
interleaving exploration can handle the search complexity of
interleaving segment coverage, and as a consequence \sys can quickly
tirgger given concurrency bugs even much faster than previous
approaches.


\dr{Is it helpful to mention that there are a few concurrency bugs
  that randomized search cannot find? ie, CVE-2019-6974.}
