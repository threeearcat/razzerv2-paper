...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.99\linewidth]{fig/comparison_graph-crop.pdf}
...
%
%
In the \texttt{Naive} column, we can identify the difficulty
of discovering varies from a bug to a bug.
%
