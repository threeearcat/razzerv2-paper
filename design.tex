...
\begin{itemize}
\item race conditions manifest depending on four memory accesses
\item the four memory accesses are channels of communications between
  multiple threads
\item 
\item commucations are established when a write operation of thread A
  is observable to another thread B
