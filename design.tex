...
interleaved instructions in \autoref{fig:keyidea}-(a),
$\texttt{B1} \Rightarrow \texttt{A2}$,
$\texttt{B1} \Rightarrow \texttt{A4}$, and
$\texttt{A6} \Rightarrow \texttt{B2}$.
%
Since these pairs describe just a single interleaivng order, the
second step is to further combine them to represent a combination of
interleaving orders.
%
