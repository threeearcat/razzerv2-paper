...
\textit{not random} unlike previous approaches~\cite{krace, ski, pctalgorithm, muzz}\yj{cites}.
%
...
%
Instead, we choose a \textit{starter} way to consume $G_{derived}$.
%
