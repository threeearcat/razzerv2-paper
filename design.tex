...
interleaving, and how they can be useful in exploring thread
interleavings.
%
...
small number (\eg, 3 or 4) of instructions.
%
...
Using a set of interleaving segments, we propose a novel interleaving
