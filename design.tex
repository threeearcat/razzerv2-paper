...
In order to decide how to schedule instructions in a next iteration, a
fuzzer speculates whole interleaving between threads to run.
%
...
interleaving, and generates scheduling points to run the recomposed
interleaving.
%
...
segments $G_{mutated}$, and utilizes $G_{mutated}$ to determine what
...
\PP{Recomposing interleaving segments to whole interleaving}
%
