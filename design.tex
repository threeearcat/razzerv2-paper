...
To this end, we adopt an idea of Merkel hashing~\cite{treehashing,
  treehashing2}.
%
\dr{I want to discuss about this part:}
...
information; it captures combinations of multiple memory-accessing
instructions as a unit of an interleaving segment
