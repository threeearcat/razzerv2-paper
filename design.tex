...
generated by permuting interleaving-order edges. Then, the fuzzer
excludes 1) ones thas are explored before, and 2) ones that contain a
loop.
...
segment graphs already explored.
%
...
To this end, the fuzzer takes $S_{derived}$ (\ie, a set of derived and
unexplored segment graphs). Then the fuzzer 1) selects a subset of
$S_{derived}$ to direct the fuzzer, and generates scheduling points to
cover selected interleaving segment graphs.
