...
interleaving orders within an interleaving segment. Semantically, if
...
next input.
%
Furthermore, \intcov is used for guiding a fuzzer to efficiently
search possible instruction interleavings.
...
interleaving segment coverage tracks a system-wide hash table of
segment graphs.
%
