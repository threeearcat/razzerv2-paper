...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{fig/intuition.pdf}
  \caption{(a) A thread interleaving example of
    ...
    globally-visible memory objects. \dr{TODO: draw compactly}}
  \label{fig:keyidea}
\end{figure}
%
...
%
In this way, we can satisfy \textbf{Design goal 2} by exploring
