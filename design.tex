...
%
If new biconflict coverage is found, we mutate the interleaving to
discover more interesting behaviors.


Instead of blindly mutating the interleaving, we adopt a mutation
strategy \textit{directed} by \textit{XXX}.
%
