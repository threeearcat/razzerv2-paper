...
%
\dr{more precise explanation and take example of figure 4}
...
These two seemingly-conflicting characteristics of interleaving graphs
enables the systematic exploration of thread interleaving.
%
In other words, it is practically impossible to thoroughly explore
thread interleavings because of the astronomical number of possible
thread interleavings.
%
However, it is \textit{easily possible} explore interleavings inside
an interleaving segment. More importantly, it is still enough to
discover concurrency bugs (as mentioned in \autoref{ss:overview}).
%
...
trials. \autoref{ss:scheduler} discusses our search strategy.
