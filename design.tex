...
confidently conclude that the input does not cause a race condition.
...
%
1) identifying undisclosed scheduling constraint pairs, 2) selecting
undisclosed scheduling constraint pairs that are not exclusive, and 3)
generating scheduling points to test the selected scheduling
constraint pairs.

\PP{Identifying undisclosed scheduling constraint pairs}
%
