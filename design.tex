...
\item \textbf{\textit{Recomposing}} a new thread interleaving from
  mutated segments to further explore thread interleavings\yj{revisit this sentence}.
\end{enumerate}
%
...
which mutates segments and recomposes a new thread\yj{a new thread?} interleaving for 
...
from a thread interleaving.%, and how they are useful in exploring thread
%interleavings.
%
...
We will discuss how to build segments in \yj{xx}.

\yj{This paragraph is redundant with Benefits of segmentizing paragraph}
...
interleaving orders of the three instructions to generate 
different (unseen) execution orders of these instructions.
%
