...
To reflect the nature of race conditions, we propose a novel coverage
...
can observe that the interleaving follows many scheduling constraint
pairs simultaneously. \dr{example?}
%
