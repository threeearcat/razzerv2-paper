...
Coverage-guided fuzzing has proven to be effective in exploring such a huge search space\yj{cite}.
...
interleaving search space to \red{quickly identify the multi-thread input} and 
