...
in large-scale fuzzing by finding concurrent bugs quickly.
...
contain \red{multiple interleavings}. Using interleaving segments, we propose 
our new interleaving coverage metric, \textit{\intcov}, which is defined as a set of detected segments.
%
...
\dr{what about remove texts about implementation?}
