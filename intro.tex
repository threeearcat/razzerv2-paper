...
\dr{remind me: speculative --> mutation-based}
...
To increase the efficiency of fuzzing in discovering concurrency bugs, several approaches
...
capability than earlier work \dr{I don't get a point}).
\sys achieves the goal with the following two key ideas:
segmenting thread interleaving and speculative\dr{mutation-based?} exploration of interleavings.
