...
is i) defining a new, effective coverage metric reflecting the nature 
of common concurrency bugs, and ii) performing our efficient search
strategy guided by the coverage metric.
