...
\sys mutates as many segments as possible and generates unexplored thread interleavings
from mutated segments, quickly navigating the search space of thread interleavings. 
