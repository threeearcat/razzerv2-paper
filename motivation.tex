...
%
\item A fuzzer should adopt a concurrency coverage metrict that
  can be used to determine that interesting thread interleaving
  remains untested.
\item A fuzzer should be able to quickly trigger untested offending
  thread interleaving.
%
\end{enumerate}
...
\begin{table}[t]
  ...
  \caption{Recent works to discover concurrency bugs in the kernel.}
