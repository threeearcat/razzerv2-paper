...
Razzer~\cite{razzer} and Snowboard~\cite{snowboard} are
coverage-oblivious.  They do not make use of any interleaving coverage
and perform their heuristic-based interleaving exploration, which
inevitably execute redundant thread interleavings.
%
...
runs a given multi-thread input more.
\dr{
안어울리는 문장:
...
%
While Conzzer~\cite{conzzer} designates two functions and run them
concurrently, Conzzer still leaves instructions' interleaving
