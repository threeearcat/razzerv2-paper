...
%
\dr{history-based? coverage-based?}
%
...
\blue{
  ...
  interleaving that rarely happen, the systematic interleaving search
  boosts up the concurrency bug discovery because it can direct the
  fuzzer to execute a specific interleaving instead of executing
  random thread interleavings thousands of times.
  %
}
