...
%
As mentioned above, alias coverage captures a single interleaving
order. But in \texttt{Interleaving \#2}, there is no unobserved
interleaving order (\ie, ($\texttt{B1} \Rightarrow \texttt{A4}$) is
already observed in \texttt{Interleaving \#1}).
%
