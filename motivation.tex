...
%
\dr{I change the term ``search strategy'' to ``exploration
  scheme''. Does it seem fine?}
%
...
\blue{
  ...
  exploration boosts up the concurrency bug discovery because it can
  direct the fuzzer to execute a specific interleaving instead of
