...
less-informative because they consider a \textit{part of the offending
  interleaving} (\eg, two instructions). Thus, they are limited in
distinguish two interleavings in \autoref{fig:alias-coverage}, and do
