...
\red{However, it is not trivial to determine the number of
  ...
  %
  This work seeks a balancing point of the number of instructions to
  track.}
...
performing randomized \red{or heuristic} exploration pervasively used
...
\autoref{fig:alias-coverage}, because they consider a \textit{part of
  the offending interleaving} (\eg, two instructions). Thus, they do
not satisfy \textbf{Design goal 1}.
%
