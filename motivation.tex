...
\textit{an interleaving of multiple memory accesses}.
...
consider an interleaving of the three memory accesses, \eg,
...
should distinguish different interleavings of multiple instructions.
%
For example,
...
the offending interleaving, \eg,
$(\texttt{A2} \Rightarrow \texttt{B1} \Rightarrow \texttt{A4})$, and,
if executed, the interleaving triggers the uninitialized access bug.
