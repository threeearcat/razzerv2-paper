...
%
From the explored execution, one can easily imagine a new interleaving order of these three
...
$(\texttt{A2} \Rightarrow \texttt{B1}) \wedge (\texttt{B1} \Rightarrow
\texttt{A4}))$, and if we execute the speculative interleaving, we can
